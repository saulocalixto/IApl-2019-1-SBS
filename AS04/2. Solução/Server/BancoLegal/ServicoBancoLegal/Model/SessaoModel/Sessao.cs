...
namespace ServicoBancoLegal.Model.LoginModel
{
    public class Sessao : ObjetoPadrao
    {
        ...
        [Importacao(NomeCampo = "Token", Tamanho = 40, Posicao = 2, Tipo = TiposEnum.Texto)]
        public Guid Token { get; set; }

        [Importacao(NomeCampo = "Internacionalizacao", Tamanho = 1, Posicao = 3, Tipo = TiposEnum.Enumerador)]
