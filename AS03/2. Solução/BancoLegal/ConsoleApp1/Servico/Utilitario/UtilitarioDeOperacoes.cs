...
namespace BancoLegal.Servico.Utilitario
{
    public class UtilitarioDeOperacoes
    {
        ...
        private UtilitarioDeImportacao _utilitarioImportacao;

        public UtilitarioDeOperacoes(Operacao operacao)
        {
            _servicoContaCorrente = new ServicoContaCorrente();
            _utilitarioImportacao = new UtilitarioDeImportacao();
            _operacao = operacao;
            _contaDestino = _utilitarioImportacao.TransformeLinhaEmObjeto<ContaCorrente>(_servicoContaCorrente.Consulte(_operacao.ContaDestino));
            _contaOrigem = _utilitarioImportacao.TransformeLinhaEmObjeto<ContaCorrente>(_servicoContaCorrente.Consulte(_operacao.ContaOrigem));
        }
